...
janitoo_entry_points = {
    "janitoo.threads": [
        "roomba = janitoo_roomba.roomba:make_thread",
    ],
    "janitoo.components": [
...
setup(
    name = 'janitoo_roomba',
    description = "A controller dedicated to the roomba",
    long_description = "A controller dedicated to the roomba",
    author='Sébastien GALLET aka bibi2100 <bibi21000@gmail.com>',
    author_email='bibi21000@gmail.com',
    keywords = "vacuum,roomba",
    license = """
        This file is part of Janitoo.
